<template>
    <div class="container col-9">
        <h1 class="text-center">WebRTC (Laravel+Vue)</h1>
        ...
        <div class="text-right mt-2" v-for="(name,userId) in others" :key="userId">
            <button class="btn btn-success" @click="startVideoChat(userId)" v-text="`Talk with ${name}`"/>
        </div>
    </div>
</template>
<script>
